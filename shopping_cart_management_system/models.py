...
class Product(Model):
    ...
    product_image = fields.CharField(max_length=150,null=False,default = 'productDefault.jpg')
...
user_pydanticOut = pydantic_model_creator(User,name = 'UserOut',exclude_readonly =('password', ))
...
productIn = pydantic_model_creator(Product,name='ProductIn',exclude=('percentage_discount','id'))
